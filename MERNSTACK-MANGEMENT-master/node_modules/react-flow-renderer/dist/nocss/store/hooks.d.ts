...
export declare const useStoreState: <Result>(mapState: (state: import("easy-peasy").StateMapper<{
    ...
    elements: import("..").Elements<any>;
    nodes: import("easy-peasy").Computed<StoreModel, import("..").Node<any>[], {}>;
    edges: import("easy-peasy").Computed<StoreModel, import("..").Edge<any>[], {}>;
    selectedElements: import("..").Elements<any> | null;
    ...
    nodeExtent: import("..").TranslateExtent;
