...
export declare const parseElement: (element: Node | Edge, nodeExtent: import("../types").TranslateExtent) => Node | Edge;
...
export declare const onLoadGetElements: (currentStore: Store<StoreModel>) => () => Elements<any>;
