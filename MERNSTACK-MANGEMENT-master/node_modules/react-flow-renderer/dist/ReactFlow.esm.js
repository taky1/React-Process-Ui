...
var wrapEdge = (function (EdgeComponent) {
    var EdgeWrapper = function (_a) {
        ...
        var onEdgeUpdaterMouseEnter = useCallback$1(function () { return setUpdating(true); }, [setUpdating]);
        var onEdgeUpdaterMouseOut = useCallback$1(function () { return setUpdating(false); }, [setUpdating]);
        if (isHidden) {
            return null;
        }
